package components
{
	...
	public class Menu extends UIComponent
	{
		...
		private function createFooter():void
		{
			...
			btnEndTurn.addEventListener(MouseEvent.CLICK, function():void
				{
					var turnSkipEvent:ActionEvent = new ActionEvent(ActionEvent.TURN_SKIP);
					dispatchEvent(turnSkipEvent);
				});
			btnSaveGame.label = "Guardar y Salir";
			btnSaveGame.addEventListener(MouseEvent.CLICK, function():void
				{
